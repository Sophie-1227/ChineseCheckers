...
public class Gra {
	...
	/**
	*Metoda zmieniajaca nawe koloru z typu string do Color
	*Jesli kolor nie zawiera sie w kolorach graczy, to zwracamy null
	@return Color.s Kolor ktory zawiera sie  w sprawdzanym stringu
	*/
	...
	*Metoda sprawdzajaca poprawnosc wykonanego ruchu
	*Sprawdzamy wszystkie mozliwosci, gdzie legalnie moglismy postawic pionek
	*Patrzymy czy ktoras zgadza sie z polem, ktore wybralismy
	*Na koniec zwracamy wartosc bool p1 lub p2 lub p3 itd
	*Co oznacza, ze jesli jedna z nich jest prawdziwa to dostaniemy true (jako ruch poprawny)
	...
	*/
	...
	/**
	*Sprawdzanie ogolne ruchu
	*Metoda sprawdzająca poprawnosc wykonanego ruchu
	*Sprawdzamy wszystkie zasady poruszania sie po planszy
	*Mamy do spelnienia 3 warunki (poprawnosc wybranego pola, nie wychodzenie z docelowego trojkata i ewentualne pominiecie tury)
	*Jesli wszystkie są spelnione to dostaniemy true (jako ruch poprawny)
	@return bool czy wykonany ruch nie lamie zadnych zasad chinskich warcab
	@see #sprawdzSkok(int, int, int, int)
	@see #czyDocelowe(int, int, String)
	*/
	...
	/**
	*Metoda przechowujaca pola docelowego trojkata dla poszczegolnych kolorow
	*Uzywana do sprawdzenia poprawnosci ruchu (pomaga w kontrolowaniu, czy gracz nie oposcil swojego trojkata docelowego)
	@see #sprawdzRuch(int, int, int, int, String)
	@return bool czy pole na ktorym jest pionek jest polem docelowym
	*/
	...
	/**
	*Metoda sprawdzajaca czy zaszla wygrana
	*Sprawdzamy po kolei kazde pole w trojkatach docelowych
	*Patrzymy, czy zadne z nich nie jest null i czy kazde z nich jest w kolorze docelowym
	*Jesli jest to zwraca nam prawde
	@return bool czy zaszla juz wygrana
	*/
	
	protected boolean hasWinner() {
		/**
		 * SPRAWDZAMY, CZY WYGRAL GRACZ CZERWONY
		 */
		...
		/**
		 * SPRAWDZAMY, CZY WYGRAL GRACZ ZIELONY
		 */
		...
		/**
		 * SPRAWDZAMY, CZY WYGRAL GRACZ NIEBIESKI
		 */
		...
		/**
		 * SPRAWDZAMY, CZY WYGRAL GRACZ POMARANCZOWY
		 */
		...
		/**
		 * SPRAWDZAMY, CZY WYGRAL GRACZ BRAZOWY
		 */
		...
		/**
		 * SPRAWDZAMY, CZY WYGRAL GRACZ FIOLETOWY
		 */
