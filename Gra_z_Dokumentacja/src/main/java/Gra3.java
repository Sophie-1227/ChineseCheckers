...
public class Gra3 extends Gra {
	...
	/**
	*Klasa zawierajaca gre dla 3 osob
	*Uruchamia sie ja gdy po uruchomieniu klasy menu wybierzemy 3 graczy i odpalimy server
	*/
	...
	/**
	*Metoda tworzaca plansze i ustawiajaca pionki dla 3 graczy
	*/
	...
	*/    
	    ...
	    *Przetwarzanie sygnałow dotyczacych ruchu od klienta
	    */
	...
	*Implementacja metody sprawdzającej czy zaszlo zwyciestwo
	@see #hasWinner()
